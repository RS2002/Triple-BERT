...
def get_args():
    ...
    parser.add_argument("--model_path",type=str,default="./3/latest.pth")
    ...
    for hour in hour_list:
        ...
        for t in pbar:
            ...
            worker.update(feedback_table, new_route_table, new_route_time_table, new_remaining_time_table,
                          new_total_travel_time_table, new_detour_table, reward, assignment, order_state, (t == args.max_step - 1), 0)
